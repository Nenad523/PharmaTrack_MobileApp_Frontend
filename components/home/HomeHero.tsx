...
export function HomeHero() {
  return (
    <View className="items-center px-4 pb-10 pt-14">
      ...
      <Text className="max-w-xs text-center text-4xl font-bold tracking-tight text-slate-900">
        Pronađite ljekove.{" "}
        <Text className="text-blue-600">Brzo i pouzdano.</Text>
      </Text>

      <Text className="mt-4 max-w-sm text-center text-base leading-7 text-slate-600">
      ...
      <View className="mt-8 w-full flex-row gap-3">
        <TouchableOpacity
          className="flex-1 flex-row items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-4"
          style={{
            shadowColor: "#2563eb",
        ...
        >
          ...
          <Text className="text-base font-semibold text-white">Pretraga</Text>
          <ArrowRight size={18} color="white" />
        </TouchableOpacity>

        <TouchableOpacity
          className="flex-1 flex-row items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-4"
          onPress={() => router.push("/(tabs)/duty")}
        >
          <Clock3 size={18} color="#374151" />
          <Text className="text-base font-semibold text-slate-700">Dežurne</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
